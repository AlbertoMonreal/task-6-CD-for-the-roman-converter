...
test("Out of range", function (assert) {
 assert.propEqual(convertIntegerToRoman("4000"), {value: , message: 'Please enter a valid integer', result: false}, "TC-8");
});
...
test("Invalid symbols", function (assert) {
 ...
 assert.propEqual(convertIntegerToRoman("0"), {value: , message: 'Please enter a valid integer', result: false}, "TC-12");
});
