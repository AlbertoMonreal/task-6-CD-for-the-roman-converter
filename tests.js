...
test("Invalid symbols", function (assert) {
 assert.propEqual(convertIntegerToRoman("1.23"), {value: 0, message: 'Please enter a valid integer', result: false}, "TC-10");
 assert.propEqual(convertIntegerToRoman("V"), {value: 0, message: 'Please enter a valid integer', result: false}, "TC-11");
 assert.propEqual(convertRomanToInteger("123"), {value: 0, message: 'Please enter a valid roman', result: false}, "TC-12");
 assert.propEqual(convertIntegerToRoman("0"), {value: 0, message: 'Please enter a valid integer', result: false}, "TC-13");
});
